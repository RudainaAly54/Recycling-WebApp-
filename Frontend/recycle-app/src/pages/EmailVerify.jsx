...
const EmailVerify = () => {
  ...
  return (
    <div className="bg-gray-100 flex flex-col min-h-screen ">
      ...
      <form onSubmit={onSubmitHandler} className="rounded-lg shadow-lg w-96 text-sm p-8 bg-white self-center flex flex-col ">
        <h1 className="text-center text-2xl font-semibold mb-4">Email Verify OTP</h1>
